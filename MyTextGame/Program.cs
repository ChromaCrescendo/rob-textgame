            ...
            public bool doBattle()
            {
                ...
                while (p1.hpCurrent > 0 && m1.hpCurrent > 0)
                {
                    ...
                    switch (input)
                    {
                        case "ATTACK":
                        case "ATK":
                            Console.WriteLine("You attack the {0} for {1} damage", m1.name, p1.dmg);
                            m1.hpCurrent -= p1.dmg;
                            Console.ForegroundColor = ConsoleColor.Green;
                            //Erase comment mark to show monster health
                            Console.WriteLine("It now has {0}/{1} health left", m1.hpCurrent, m1.hpMax);
                            Console.ForegroundColor = ConsoleColor.Gray;
                            break;
                    ...
                    {
                        Console.ForegroundColor = ConsoleColor.Red;
                        Console.WriteLine("The {0} attacks you for {1} damage", m1.name, m1.dmg);
                        ...
                        Console.ForegroundColor = ConsoleColor.Green;
                        Console.WriteLine("You now have {0}/{1} health left\n", p1.hpCurrent, p1.hpMax);
                        //Console.WriteLine();
                        Console.ForegroundColor = ConsoleColor.Gray;
                    }
                    else
